    ...
    return (
      <div className={`min-h-screen ${currentTheme.bg} flex items-center justify-center`}>
        <div className="text-center">
          ...
          <p className={`${currentTheme.text} text-lg`}>Loading profile...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container py-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-6">
            <h1 className={`text-3xl font-bold ${currentTheme.text} mb-1 flex items-center justify-center gap-2`}>
              <User className="h-8 w-8" />
              Your Profile Hub
            </h1>
            <p className={`${currentTheme.muted}`}>Make it uniquely you!</p>
          </div>
          ...
          <div className={`${currentTheme.cardBg} rounded-xl p-6 border ${currentTheme.border} shadow-lg`}>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className={`${currentTheme.text} text-sm mb-1`}>
                  {formData.bio || "Add your bio"}
                </p>
                <p className={`${currentTheme.muted} text-xs flex items-center gap-1`}>
            ...
            <Tabs defaultValue="profile" className="space-y-4">
              ...
              <TabsContent value="wallet" className="space-y-4">
                <div className={`${currentTheme.secondary} p-4 rounded-lg border-2 border-dashed border-purple-300`}>
              ...
              <TabsContent value="settings" className="space-y-4">
                <div className="space-y-4">
                  <h3 className={`text-lg font-semibold ${currentTheme.text} mb-3 flex items-center gap-2`}>
                  ...
                  <div className="space-y-3">
                    <div className={`flex items-center justify-between p-4 rounded-lg ${currentTheme.secondary} border border-purple-200`}>
                      <div>
                        ...
                        <p className={`text-sm ${currentTheme.muted}`}>Updates about transactions and messages</p>
                      </div>
                      <Switch
                    ...
                    <div className={`flex items-center justify-between p-4 rounded-lg ${currentTheme.secondary} border border-purple-200`}>
                      <div>
                        ...
                        <p className={`text-sm ${currentTheme.muted}`}>Extra security for your account</p>
                      </div>
                      <Switch
